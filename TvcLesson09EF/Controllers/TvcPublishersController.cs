...
{
    public class TvcPublishersController : Controller
    {
        private readonly TvcBookStoreContext _context;

        public TvcPublishersController(TvcBookStoreContext context)
        {
            _context = context;
        }
        ...
        // GET: TvcPublishers/Create
        public IActionResult Create()
        {
            return View();
        }

        // POST: TvcPublishers/Create
